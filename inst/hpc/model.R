...
# each QuantID needs to be backed up by at least two measurements, otherwise our model cannot differentiate peptide and feature variance
# TODO: maybe we shouldn't do this?
#dd <- dd[ , if (.N > 1) .SD, by = QuantID]
...
#save(mcmc.quants, mcmc.assays.quants, mcmc.assays.sd, mcmc.peptides.quants, mcmc.peptides.sd, mcmc.features.sd, time.mcmc, file = paste0(batch, ".", chain, ".Rdata"))
