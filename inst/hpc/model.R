...
dd.assay.exposures <- merge(dd.assay.exposures, dd.assay.exposures[AssayID == levels(AssayID)[1], .(chainID, mcmcID, shift = value)])
dd.assay.exposures[, value := value - shift]
dd.assay.exposures <- dd.assay.exposures[, .(median = median(value), mad = mad(value)), by = AssayID]
