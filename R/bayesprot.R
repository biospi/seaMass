...
bayesprot <- function(dd, id = "bayesprot", ref.assays = levels(dd$Assay), missing = "censored", de.conditions = NULL, de.paired = F, de.truth = NULL, prior.scale = 1,
  ...
  # setup input
  process.input(dd, id, ref.assays, missing, de.conditions, de.paired = de.paired, de.truth = de.truth, prior.scale = prior.scale,
