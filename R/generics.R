if (!exists("add_to_report")) setGeneric("add_to_report", function(object, ...) standardGeneric("add_to_report"))
...
if (!exists("init_report")) setGeneric("init_report", function(object, ...) standardGeneric("init_report"))
...
if (!exists("render_report")) setGeneric("render_report", function(object, ...) standardGeneric("render_report"))
