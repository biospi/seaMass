...
if (!exists("centre_group_quants")) setGeneric("centre_group_quants", function(object, ...) standardGeneric("centre_group_quants"))
if (!exists("centred_group_quants")) setGeneric("centred_group_quants", function(object, ...) standardGeneric("centred_group_quants"))
...
if (!exists("standardise_theta")) setGeneric("standardise_theta", function(object, ...) standardGeneric("standardise_theta"))
if (!exists("standardise_median")) setGeneric("standardise_median", function(object, ...) standardGeneric("standardise_median"))
if (!exists("standardise_quantile")) setGeneric("standardise_quantile", function(object, ...) standardGeneric("standardise_quantile"))
...
if (!exists("standardised_group_quants_fdr")) setGeneric("standardised_group_quants_fdr", function(object, ...) standardGeneric("standardised_group_quants_fdr"))
if (!exists("standardised_group_variances")) setGeneric("standardised_group_variances", function(object, ...) standardGeneric("standardised_group_variances"))
