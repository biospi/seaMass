...
if (!exists("exposure_theta")) setGeneric("exposure_theta", function(object, ...) standardGeneric("exposure_theta"))
if (!exists("exposure_median")) setGeneric("exposure_median", function(object, ...) standardGeneric("exposure_median"))
if (!exists("exposure_quantile")) setGeneric("exposure_quantile", function(object, ...) standardGeneric("exposure_quantile"))
