...
setGeneric("finish", function(object, ...) standardGeneric("finish"))
...
setGeneric("normalised_group_variances", function(object, ...) standardGeneric("normalised_group_variances"))
