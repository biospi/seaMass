...
#' @export
#' @include generics.R
setMethod("plot_assay_means", "seaMass_sigma", function(object, assays = NULL, sort.cols = NULL, label.cols = c("Sample", "Assay"), horizontal = TRUE, colour = "Assay.SD", colour.guide = ggplot2::guide_colorbar(barwidth = unit(50, "mm")), fill = "Block", fill.guide = NULL, file = NULL, value.length = 120, level.length = 5) {
