...
#'   \code{c("model0", "measurement.vars", "component.vars", "component.deviations", "assay.deviations", "unnormalised.group.quants")}
...
sigma_control <- function(
  summarise = NULL,
  keep = c("model0", "measurement.vars", "component.vars", "component.deviations", "unnormalised.group.quants"),
  plot = NULL,
...
setValidity("sigma_control", function(object) {
  ...
  if (!(all(object@keep %in% c("model0", "measurement.vars", "component.vars", "component.deviations", "assay.deviations", "unnormalised.group.quants")))) return("'keep' is not valid!")
