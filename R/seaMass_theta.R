...
#' @return A \code{seaMass_theta} object, which allows access to metadata and each block's \link{sigma_block} object to access
#'   various results.
#' @import data.table
...
seaMass_theta <- function(
  ...
  object <- open_theta(path, quiet = T)
  if (!is.null(object)) {
  ...
  ### RUN
  object <- new("seaMass_theta", filepath = path)
...
setMethod("finish", "seaMass_theta", function(object, job.id) {
  ...
  if (!("normalised.group.stdevs" %in% ctrl@keep)) for (block in blocks(object)) unlink(file.path(filepath(block), "model1", "normalised.group.stdevs*"), recursive = T)
...
#' @describeIn seaMass_theta-class Open a complete \code{seaMass_theta} run from the supplied \code{path}.
#' @export
open_theta <- function(
  path = "fit.seaMass",
  quiet = FALSE,
  ...
  object <- new("seaMass_theta", filepath = normalizePath(path2))
...
#' @describeIn seaMass_theta-class Get the \link{sigma_control}.
#' @export
#' @include generics.R
...
#' @describeIn seaMass_theta-class Open the list of \link{seaMass_delta} objects.
#' @export
#' @include generics.R
setMethod("open_deltas", "seaMass_theta", function(object, quiet = FALSE, force = FALSE) {
...
#' @describeIn seaMass_theta-class Get the model timings as a \link{data.frame}.
#' @import data.table
#' @export
#' @include generics.R
setMethod("timings", "seaMass_theta", function(object, input = "model1", as.data.table = FALSE) {
...
#' @export
#' @include generics.R
setMethod("read_samples", "seaMass_theta", function(object, input, type, items = NULL, chains = 1:control(object)@model.nchain, summary = NULL, summary.func = "robust_normal", as.data.table = FALSE) {
...
#' @describeIn seaMass_theta-class Get the model assay stdevs as a \link{data.frame}.
#' @import data.table
#' @export
#' @include generics.R
setMethod("assay_stdevs", "seaMass_theta", function(object, input = "model1", as.data.table = FALSE) {
...
#' @describeIn seaMass_theta-class Get the model assay deviations as a \link{data.frame}.
#' @import doRNG
#' @import data.table
#' @export
#' @include generics.R
...
#' @describeIn seaMass_theta-class Get the model measurement means as a \link{data.frame}.
#' @import data.table
#' @export
#' @include generics.R
...
#' @describeIn seaMass_theta-class Get the model measurement stdevs as a \link{data.frame}.
#' @import data.table
#' @export
#' @include generics.R
...
#' @describeIn seaMass_theta-class Get the model component means as a \link{data.frame}.
#' @import data.table
#' @export
#' @include generics.R
...
#' @describeIn seaMass_theta-class Get the model component stdevs as a \link{data.frame}.
#' @import data.table
#' @export
#' @include generics.R
...
#' @describeIn seaMass_theta-class Gets the model component deviations as a \link{data.frame}.
#' @import data.table
#' @export
#' @include generics.R
...
#' @describeIn seaMass_theta-class Get the model group means as a \link{data.frame}.
#' @import data.table
#' @export
#' @include generics.R
...
#' @describeIn seaMass_theta-class Get the model normalised group stdevs as a \link{data.frame}.
#' @import data.table
#' @export
#' @include generics.R
...
#' @describeIn seaMass_theta-class Get the model normalised group quantifications as a \link{data.frame}.
#' @import data.table
#' @export
#' @include generics.R
...
#' @export
#' @include generics.R
setMethod("plot_assay_means", "seaMass_theta", function(object, data, limits = NULL, alpha = 1, facets = NULL, sort.cols = c("Block", "Assay"), label.cols = c("Block", "Assay", "Sample"), title = NULL, horizontal = TRUE, colour = "A.qD", fill = "A.qD", file = NULL, value.length = 80, level.length = 5) {
...
#' @export
#' @include generics.R
setMethod("plot_assay_stdevs", "seaMass_theta", function(object, data, limits = NULL, alpha = 1, facets = NULL, sort.cols = c("Block", "Assay"), label.cols = c("Block", "Assay", "Sample"), title = NULL, horizontal = TRUE, colour = "A.qD", fill = "A.qD", file = NULL, value.length = 80, level.length = 5) {
...
#' @export
#' @include generics.R
setMethod("plot_group_means", "seaMass_theta", function(object, data, limits = NULL, alpha = 1, facets = ~ Group, sort.cols = c("Group", "Block"), label.cols = "Block", title = NULL, horizontal = TRUE, colour = "G.qC", fill = "G.qC", file = NULL, value.length = 80, level.length = 5) {
  return(plot_dists(object, data, limits, alpha, facets, sort.cols, label.cols, title, value.label = "mean", horizontal, colour, fill, file, value.length, level.length))
})
...
#' @export
#' @include generics.R
setMethod("plot_group_quants", "seaMass_theta", function(object, data, limits = NULL, alpha = 1, facets = ~ Group, sort.cols = c("Group", "Assay"), label.cols = c("Assay", "Sample", "Block"), title = NULL, horizontal = TRUE, colour = "Condition", fill = "Condition", file = NULL, value.length = 80, level.length = 5) {
...
#' @export
#' @include generics.R
setMethod("plot_normalised_group_quants", "seaMass_theta", function(object, data, limits = NULL, alpha = 1, facets = ~ Group, sort.cols = c("Group", "Assay"), label.cols = c("Assay", "Sample", "Block"), title = NULL, horizontal = TRUE, colour = "Condition", fill = "Condition", file = NULL, value.length = 80, level.length = 5) {
  return(plot_dists(object, data, limits, alpha, facets, sort.cols, label.cols, title, value.label = "quant", horizontal, colour, fill, file, value.length, level.length))
})
...
#' @export
#' @include generics.R
setMethod("plot_normalised_group_means", "seaMass_theta", function(object, data, limits = NULL, alpha = 1, facets = ~ Group, sort.cols = c("Group", "Block"), label.cols = "Block", title = NULL, horizontal = TRUE, colour = "G.qC", fill = "G.qC", file = NULL, value.length = 80, level.length = 5) {
  return(plot_dists(object, data, limits, alpha, facets, sort.cols, label.cols, title, value.label = "mean", horizontal, colour, fill, file, value.length, level.length))
})
...
#' @export
#' @include generics.R
setMethod("plot_normalised_group_stdevs", "seaMass_theta", function(object, data, limits = NULL, alpha = 1, facets = ~ Group, sort.cols = c("Group", "Block"), label.cols = "Block", title = NULL, horizontal = TRUE, colour = "G.qC", fill = "G.qC", file = NULL, value.length = 80, level.length = 5) {
  return(plot_dists(object, data, limits, alpha, facets, sort.cols, label.cols, title, value.label = "stdev", horizontal, colour, fill, file, value.length, level.length))
})
...
#' @export
#' @include generics.R
setMethod("plot_standardised_group_deviations", "seaMass_theta", function(object, data, limits = NULL, alpha = 1, facets = ~ Group, sort.cols = c("Group", "Assay"), label.cols = c("Assay", "Sample", "Block"), title = NULL, horizontal = TRUE, colour = "Condition", fill = "Condition", file = NULL, value.length = 80, level.length = 5) {
...
#' @export
#' @include generics.R
setMethod("plot_component_deviations", "seaMass_theta", function(object, data, limits = NULL, alpha = 1, facets = ~ Component, sort.cols = c("Group", "Component", "Assay"), label.cols = c("Block", "Assay", "Sample"), title = "Group", horizontal = TRUE, colour = "Condition", fill = "Condition", file = NULL, value.length = 80, level.length = 5) {
  return(plot_dists(object, data, limits, alpha, facets, sort.cols, label.cols, title, value.label = "deviation", horizontal, colour, fill, file, value.length, level.length))
})
...
#' @export
#' @include generics.R
setMethod("plot_component_means", "seaMass_theta", function(object, data, limits = NULL, alpha = 1, facets = ~ Component, sort.cols = c("Group", "Component", "Block"), label.cols = "Block", title = "Group", horizontal = TRUE, colour = "C.qM", fill = "C.qM", file = NULL, value.length = 80, level.length = 5) {
  return(plot_dists(object, data, limits, alpha, facets, sort.cols, label.cols, title, value.label = "mean", horizontal, colour, fill, file, value.length, level.length))
})
...
#' @export
#' @include generics.R
setMethod("plot_component_stdevs", "seaMass_theta", function(object, data, limits = NULL, alpha = 1, facets = ~ Component, sort.cols = c("Group", "Component", "Block"), label.cols = "Block", title = "Group", horizontal = TRUE, colour = "C.qM", fill = "C.qM", file = NULL, value.length = 80, level.length = 5) {
  return(plot_dists(object, data, limits, alpha, facets, sort.cols, label.cols, title, value.label = "stdev", horizontal, colour, fill, file, value.length, level.length))
})
...
#' @export
#' @include generics.R
setMethod("plot_measurement_means", "seaMass_theta", function(object, data, limits = NULL, alpha = 1, facets = ~ Component + Measurement, sort.cols = c("Group", "Component", "Measurement", "Block"), label.cols = "Block", title = "Group", horizontal = TRUE, colour = "M.qD", fill = "M.qD", file = NULL, value.length = 80, level.length = 5) {
  return(plot_dists(object, data, limits, alpha, facets, sort.cols, label.cols, title, value.label = "mean", horizontal, colour, fill, file, value.length, level.length))
})
...
#' @export
#' @include generics.R
setMethod("plot_measurement_stdevs", "seaMass_theta", function(object, data, limits = NULL, alpha = 1, facets = ~ Component + Measurement, sort.cols = c("Group", "Component", "Measurement", "Block"), label.cols = "Block", title = "Group", horizontal = TRUE, colour = "M.qD", fill = "M.qD", file = NULL, value.length = 80, level.length = 5) {
  return(plot_dists(object, data, limits, alpha, facets, sort.cols, label.cols, title, value.label = "stdev", horizontal, colour, fill, file, value.length, level.length))
})
