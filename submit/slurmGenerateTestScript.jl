...
#  write(f,"srun julia bayesprot-import-setup.jl\n")
  write(f,"srun echo julia bayesprot-import-setup.jl\n")
end
...
#  write(f,"srun Rscript ../../import.R HPC\n")
  write(f,"srun echo Rscript ../../import.R HPC\n")
end
...
#  write(f,"srun julia bayesprot-norm-setup.jl $normChains $normJobs\n")
  write(f,"srun echo julia bayesprot-norm-setup.jl $normChains $normJobs\n")
end
...
#  write(f,"srun sh norm/norm-job\$PBS_ARRAYID.sh\n")
  write(f,"srun echo sh norm/norm-job\$PBS_ARRAYID.sh\n")
end
...
#  write(f,"srun julia bayesprot-exposures-setup.jl\n")
  write(f,"srun echo julia bayesprot-exposures-setup.jl\n")
end
...
#  write(f,"srun Rscript ../../exposures.R HPC\n")
  write(f,"srun echo Rscript ../../exposures.R HPC\n")
end
...
#  write(f,"srun julia bayesprot-model-setup.jl $modelChains $modelJobs\n")
  write(f,"srun echo julia bayesprot-model-setup.jl $modelChains $modelJobs\n")
end
...
#  write(f,"srun sh model/model-job\$PBS_ARRAYID.sh\n")
  write(f,"srun echo sh model/model-job\$PBS_ARRAYID.sh\n")
end
...
#  write(f,"srun julia bayesprot-plots-setup.jl $plotsJobs\n")
  write(f,"srun echo julia bayesprot-plots-setup.jl $plotsJobs\n")
end
...
#  write(f,"srun sh plots/plots-job\$PBS_ARRAYID.sh\n")
  write(f,"srun echo sh plots/plots-job\$PBS_ARRAYID.sh\n")
end
...
#  write(f,"srun julia bayesprot-output-setup.jl")
  write(f,"srun echo julia bayesprot-output-setup.jl")
end
...
#  write(f,"srun Rscript ../../output.R HPC")
  write(f,"srun echo Rscript ../../output.R HPC")
end
